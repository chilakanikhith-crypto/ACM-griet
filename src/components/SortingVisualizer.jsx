        ...
        {array &&
          array.map((value, idx) => {
            ...
            if (isSorted) {
              ...
              barBg =
                'bg-gradient-to-t from-amber-900 via-amber-500 to-yellow-300 text-slate-950 font-bold border-yellow-300 scale-[1.02] z-10';
